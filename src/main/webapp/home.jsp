                ...
                <li class="header__navbar-item isnone">
                    <a href="" class="header__nabar-link">
                        ...
                        <label for="newpost-on-off-id" class="newpost-off">
                            <a href="/posts?action=create&userId=${userLogging.id}">
                                    ...
                                    <div class="accountfolder-wraper">
                                        <div class="accountfolder-inner">
                                            <div class="accountfolder-about btn">
                                                ...
                                                <div class="accountfolder-about-content">
                                                    <div class="accountfolder-about-content__Profile">
                                                        <a href="/posts?action=update&&userId=${userLogging.id}&&postId=${p.id}"
                                                        style="text-decoration: none; color: #262626">Edit
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accountfolder-about btn">
                                                ...
                                                <div class="accountfolder-about-content">
                                                    <div class="accountfolder-about-content__Saved">
                                                        <button type="button" onclick="deleteS(${p.id}, ${userLogging.id})"
                                                        style=" color: #262626; border: none;border: white; background-color: white">
                                                            Delete
                                                        </button>
                                                    </div>
                                                </div>
...
function deleteS(id,userId) {
    if (confirm("Are you sure?")) {
        window.location.href = `/posts?action=delete&&id=` + id+ `&&userId=` +  userId
    }
}
